@echo off
::Code Flex free tweaking utility  Code Flex TWEAKS, S.R.O. ® 2025
...
echo. 
echo.                                                    %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                           %W%   Code Flex is not running as Admin!
echo.                                         
...
echo. 
echo. 
echo.                                                                                                  %W% Code Flex FREE TWEAKING UTILITY  
echo.
echo.
echo.                                                                                    %p% ██╗       ██╗███████╗██╗      █████╗  █████╗ ███╗   ███╗███████╗ 
echo.                                                                                    %p% ██║  ██╗  ██║██╔════╝██║     ██╔══██╗██╔══██╗████╗ ████║██╔════╝ 
...
echo.
echo.                                            You can find the tutorial, more information about the utility and much more in the Code Flex Tweaks https://www.youtube.com/@codeflex1
echo.  
echo.                                                                                   Made and distributed by Code Flex TWEAKS * Updated 12th of January
echo.
echo.
echo.                                          %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                               
...
chcp 437 >nul
powershell "Checkpoint-Computer -Description 'Code Flex Tweaks Restore Point'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 
cls
goto :resources
...
cls
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloading resources (power plan, Nvidia profile inspector & more, Press "OK" To continue)', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
cls 
...
powershell "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded resources successfully, Press "OK" To continue to the menu! ', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo. 
echo.                                                           %p%[%w%4%p%]%w% GPU Optimizations                  %p%[%w%5%p%]%w% CPU Optimizations                     %p%[%w%6%p%]%w% USB Optimizations                    
echo.                                                                                                                                                                                 
echo.                                                           %p%[%w%7%p%]%w% System Debloat                     %p%[%w%8%p%]%w% Storage Optimizations                 %p%[%w%9%p%]%w% Memory Optimizations
echo.                                                                                                                                                                                 
echo.                                                           %p%[%w%10%p%]%w% Fix Corrupted Files               %p%[%w%11%p%]%w% Uninstall Useless Apps               %p%[%w%12%p%]%w% PC clean        
echo.                                                                                                                                                                                 
echo.                                                           %p%%p%%p%%p%                                       %p%[%w%13%p%]%w% Code Flex Network Tweaking Utility        
echo.
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
...
echo.                                                                                                                                                                                 
echo.                                                           %p%[%w%R%p%]%w% Reverts                            %p%[%w%X%p%]%w% Exit The Utility                      %p%[%w%E%p%]%w% Code Flex Tweaks Youtube Channel
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                  
echo.                                                                                %p%%p%%p%%w%  Made and distributed by Code Flex TWEAKS * Updated 14th of January 2025                   
echo.
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
if /i %input% == W start https://www.youtube.com/@codeflex1
if /i %input% == E start https://www.youtube.com/@codeflex1
...
echo.                                                                                                                        
echo.                                                                       %p%[%w%5%p%]%w% Revert GPU Category (coming soon)                                          
echo.                                                                                                                       
echo.                                                                       %p%[%w%6%p%]%w% Revert CPU Category     
echo.
echo.                                                                       %p%[%w%7%p%]%w% Revert USB Category
echo.  
echo.                                                                       %p%[%w%8%p%]%w% Revert Power Category
echo.
echo.                                                                       %p%[%w%9%p%]%w% Revert Debloat Category
echo.
echo.                                                                       %p%[%w%10%p%]%w% Revert Storage Category
echo.
echo.                                                                       %p%[%w%11%p%]%w% Revert Network Utility 
echo.
echo.                                                                       %p%[%w%12%p%]%w% Revert Uninstall
echo.
echo.
echo.                                                                                                                       
...
echo.                                               %W% Its still reccomended to use a restore point if you want to get rid of the tweaks completely
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.
set /p input=:
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('! Make sure to restart your pc after using, so the tweaks properly apply !, thanks for using the Code Flex utility. Press "ok" to exit', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
pause > nul
cls
...
:edgingon
echo %w% - Reinstalling Microsoft edge (may not work 100% of the time, if it doesnt, use a restore point) %b%
chcp 437 >nul 
...
echo.                                                                                                                                                      
echo.                                                                                           %p%%w%%p%%w%                 %p%[%w%B%p%]%w% Bufferbloat Test  
echo.
echo.                                                       %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.    
...
echo.
echo.                                                                                          %p%%w%%p%%w%                  %p%[%w%15%p%]%w% Toggle bufferbloat                                    
echo.
echo.                                                      %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo. 
echo.                                                                     %p%[%w%R%p%]%w% Revert All                                             %p%[%w%M%p%]%w% Back to menu                                                       
echo.
echo.                                                                      %w%  Made and distributed by Code Flex TWEAKS * Updated 9th of January 2025 
echo.
echo.                                                      %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                 
echo.
...
if /i %input% == T start https://www.youtube.com/@xCode Flexx/videos
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                                %p%[%w%1%p%]%w% Less bufferbloat but lower network speed 	      
echo. 
echo.                                                                %p%[%w%2%p%]%w% Normal speed and normal bufferbloat (default)
echo. 
echo.
echo.                                                                              %p%[%w%M%p%]%w% Back to menu
echo. 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                    This will either enable or disable autotuning depending on the option you choose
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
:n14
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('!WARNING! You can only use this if you are on ethernet, if you are on wifi, press "N" on the next page', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo %w% This fix takes you to a discord message in my discord server (https://discord.gg/yRCW9Rdq5P)%B%
...
echo.                                                                                           
echo.                                                                      %p%[%w%4%p%]%w% Optimize NVME Settings 
echo.
echo.                                                                                           
echo.                                                                         %p%[%w%M%p%]%w% Back to menu         
echo.                      
...
:7war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: If you want to revert anything, you can do it in our revert category on the main page of the utility', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.
echo.                                                              %p%[%w%3%p%]%w% Disable Bluetooth         %p%[%w%4%p%]%w% Disable Printing and Maps 
echo. 
...
echo.                                            %p%╚═╝  ╚═╝ ╚═════╝    ╚═╝    ╚════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚══╝╚═════╝ 
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('After you press ok it will open an app, Go to the LOGON section, Disabling all services except: antivirus, cmd.exe, and the n/a services', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                            %p% ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝  ╚═════╝ ╚══════╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: Disabling Windows Updates will break Microsoft store, if you want to use it again simply press "Enable" in windows update blocker ', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                              %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                        %p%[%w%1%p%]%w% Disable Bluetooth      %p%[%w%2%p%]%w% Enable Bluetooth (default)
echo.
echo.
echo.                                                                             %p%[%w%M%p%]%w% Back to Menu  
echo. 
...
echo.                                              note: you need to have updates enabled for it to work, the revert will enable them
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════"%w%
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                                     %p%[%w%1%p%]%w% Uninstall microsoft edge
echo.                                                                                         
echo.                                                                               %p%[%w%S%p%]%w% Skip  
echo.                     
echo.
...
:5war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has bad overheating issues', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
echo.                                                                %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                                     %p%[%w%1%p%]%w% Enable Game Mode (WIN 11)          %p%[%w%2%p%]%w% Disable Game Mode (WIN 10)
echo.
echo.                           
echo.                                                                                                 %p%[%w%M%p%]%w% Back to menu    
echo.                                                                             
...
:2war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has overheating issues', 'Code Flex Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
:2
...
echo.                                                                           %p%[%w%A%p%]%w% Apply All 
echo.                                             
echo.                                                                  %p%[%w%1%p%]%w% Apply Code Flex Free Power Plan V6              
echo.                                                                                           
...
echo.                                              %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                       %p%[%w%1%p%]%w% Default Power Plans                    %p%[%w%2%p%]%w% Skip and go to menu
echo.
echo.                                                                                     
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                                   %p%[%w%1%p%]%w% GPU Hardware Acceleration Off (Reccomended)
echo.  
echo.                                                                   %p%[%w%2%p%]%w% GPU Hardware Acceleration On (Default)
echo. 
echo.                                                                                         
echo.                                                                             %p%[%w%M%p%]%w% Back to menu   
echo.                     
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                                 %p%[%w%1%p%]%w% Apply General Usb Optimizations
echo. 
echo.                                                                                         
echo.                                                                            %p%[%w%M%p%]%w% Back to menu   
echo.
...
echo.
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                  %W%Applies a bunch of usb related optimizations, disables selective suspend etc...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo. 
echo. 
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════"   
echo.                                                                                                                       
echo.                                                    %p%[%w%1%p%]%w% High end CPU                %p%[%w%2%p%]%w% Mid end CPU               %p%[%w%3%p%]%w% Low end CPU                  
echo.                                                                                                                                                                                       
echo.                                                                                                                      
echo.                                                    %p%%p%%p%%p%                          %p%[%w%T%p%]%w% Open Task Manager                                     
echo.                                                                                                                       
